...
export default function QuickFilters({
  ...
  const presetFilters: FilterPreset[] = [
    ...
    },
    {
      ...
      filter: (story) => story.assignees.includes(currentUser),
      count: stories.filter(s => s.assignees.includes(currentUser)).length,
    },
    {
      id: 'unassigned',
      name: 'Unassigned',
      ...
      filter: (story) => story.assignees.length === 0,
      count: stories.filter(s => s.assignees.length === 0).length,
    },
    {
      id: 'high-priority',
      name: 'High Priority',
